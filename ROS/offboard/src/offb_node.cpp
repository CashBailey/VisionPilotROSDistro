...
/**
 * @brief Callback function to handle incoming Float64MultiArray messages for translation.
 *
 * This function is called whenever a new Float64MultiArray message is received on the subscribed topic.
 * It expects the message to contain exactly 3 elements representing the translation in x, y, and z directions.
 * If the message does not contain 3 elements, a warning is logged and the function returns without processing.
 *
 * @param msg A pointer to the received Float64MultiArray message.
 */
